                            ...
                            <div class="the-content">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div itemscope="" itemtype="http://schema.org/Organization">
                                                    <p class="name">CÔNG TY TNHH NÔNG NGHIỆP QUỐC TẾ FAU</p>
                                ...
                                <div class="formContact">
                                    ...
                                    <form id="formContact" class="form validate">
                                        <div class="row">
                                            <!--NAME-->
                                            <div class="row-form col-md-7 col-sm-9 col-xs-12 form-ct">
                                            ...
                                            <!--END CODE SECURITY-->
                                            <!--SEND-->
                                            <div class="row-form col-md-7 col-sm-9 col-xs-12 c-button form-ct">
